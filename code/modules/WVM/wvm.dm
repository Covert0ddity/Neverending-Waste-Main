...
/obj/machinery/mineral/wasteland_vendor/weapons
	...
	prize_list = list(
		...
		new /datum/data/wasteland_equipment("Riot Shotgun",					/obj/item/gun/ballistic/shotgun/riot,								799),
		new /datum/data/wasteland_equipment("Compact Combat Shotgun",		/obj/item/gun/ballistic/shotgun/automatic/combat/compact,			950),
		new /datum/data/wasteland_equipment("Combat Shotgun",				/obj/item/gun/ballistic/shotgun/automatic/combat ,					1099),
		new /datum/data/wasteland_equipment("Cycler Semi-Automatic Shotgun",	/obj/item/gun/ballistic/shotgun/automatic/dual_tube,			2499),
		...
		new /datum/data/wasteland_equipment("Colt Rangemaster",				/obj/item/gun/ballistic/shotgun/automatic/hunting,					1499),
		new /datum/data/wasteland_equipment("Lever Action Shotgun",			/obj/item/gun/ballistic/shotgun/trench,								180),
		new /datum/data/wasteland_equipment("Hunting Rifle",				/obj/item/gun/ballistic/shotgun/remington,							165),
		new /datum/data/wasteland_equipment("Scoped Hunting Rifle",			/obj/item/gun/ballistic/shotgun/remington/scoped,					399),
		...
		new /datum/data/wasteland_equipment("AEP7 laser pistol",			/obj/item/gun/energy/laser/pistol,									799),
		new /datum/data/wasteland_equipment("AER9 laser rifle",				/obj/item/gun/energy/laser/aer9 ,									1499),
		new /datum/data/wasteland_equipment("Plasma pistol",				/obj/item/gun/energy/laser/plasma/pistol,							1699),
		new /datum/data/wasteland_equipment("Plasma rifle",					/obj/item/gun/energy/laser/plasma,									2898),
...
/obj/machinery/mineral/wasteland_vendor/clothing
	...
	prize_list = list(
		...
		new /datum/data/wasteland_equipment("Combat helmet MK2",					/obj/item/clothing/head/helmet/f13/combat/mk2,				750),
		...
		new /datum/data/wasteland_equipment("Combat armor MK2",					/obj/item/clothing/suit/armor/f13/combat/mk2,					980),
		new /datum/data/wasteland_equipment("Ranger Armor",					/obj/item/clothing/suit/armor/f13/rangercombat,						7500),

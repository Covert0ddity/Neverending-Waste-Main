...
/obj/machinery/mineral/wasteland_vendor/weapons
	...
	prize_list = list(
		...
		new /datum/data/wasteland_equipment("Plasma pistol",				/obj/item/gun/energy/laser/plasma/pistol,							12000),
		new /datum/data/wasteland_equipment("Plasma rifle",					/obj/item/gun/energy/laser/plasma,									15922),
